...
<div class="acf-file-uploader clearfix <?php echo $o['class']; ?>" data-library="<?php echo $field['library']; ?>">
	...
	<div class="has-file">
		<ul class="hl clearfix">
			<li>
				...
				<div class="hover">
					<ul class="bl">
						<li><a href="#" class="acf-button-delete ir">Удалить</a></li>
						<li><a href="#" class="acf-button-edit ir">Редактировать</a></li>
					</ul>
				</div>
			</li>
			<li>
	...
	<div class="no-file">
		<ul class="hl clearfix">
			<li>
				<span><?php _e('Файл не выбран','acf'); ?></span>. <a href="#" class="button add-file"><?php _e('Добавить','acf'); ?></a>
			</li>
		</ul>
	</div>
</div>
