	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('chosen_select', 'acf-chosen_select');
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-chosen_select'),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __('Font Size','acf-chosen_select'),
			'instructions'	=> __('Customise the input font size','acf-chosen_select'),
			'type'			=> 'number',
			'name'			=> 'font_size',
			'prepend'		=> 'px',
		));
