...
class acf_options_page_plugin
{
    ...
    */
    ...
    function __construct()
    {
        // vars
        $this->settings = array(
            'title' => __('Калькулятор', 'acf'),
            'menu' => __('Калькулятор', 'acf'),
            'slug' => 'acf-options',
    ...
    function init()
    {
        ...
        if (!empty($this->settings['pages'])) {
            ...
            $defaults = array(
                ...
                'parent' => '',
                'capability' => '',
                'dash-icon' => 'dashicons-admin-tools',
                'position' => ''
            );
    ...
    */
    ...
    function admin_menu()
    {
        ...
        if ($this->settings['show_parent']) {
            ...
            $parent_page = add_menu_page($this->settings['title'], $this->settings['menu'], $this->settings['capability'], $this->settings['slug'], array($this, 'html'), $this->settings['dash-icon'], $this->settings['position']);
...
function acf_add_options_sub_page($page = false, $slug = false)
{
    // validate
    if (!$page) {
        return false;
    ...
    $GLOBALS['acf_options_page']->settings['pages'][$slug_page] = $page;
...
if (!function_exists('register_options_page')) {
    function register_options_page($title = false, $slug = false)
    {
        acf_add_options_sub_page($title, $slug);
    }
}
